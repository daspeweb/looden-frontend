import * as parallel from '/node_modules/run-parallel/index.js'
...
export function dragDrop (elem, listeners) {
  ...
  function onDrop (e) {
    ...
    if (listeners.onDrop && e.dataTransfer.items) {
      ...
      parallel.runParallel(items.map(item => {
        return cb => {
...
export function processEntry (entry, cb) {
  let entries = []
  ...
  function doneEntries () {
    parallel.runParallel(entries.map(entry => {
      return cb => {
